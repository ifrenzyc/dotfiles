...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (helm-fuzzier helm-projectile zoom-window yascroll yaml-mode which-key web-mode use-package try swiper sublimity smooth-scrolling smex smartparens smart-mode-line-powerline-theme selected scratch rainbow-delimiters quasi-monochrome-theme powerline-evil plantuml-mode phoenix-dark-mono-theme paper-theme pangu-spacing org-super-agenda org-bullets nyan-mode neotree markdown-toc markdown-mode+ magit logstash-conf linum-relative key-chord json-mode js2-mode indent-guide ido-vertical-mode ido-ubiquitous htmlize highlight-symbol highlight-indentation helm-swoop helm-mt helm-descbinds helm-ag hc-zenburn-theme gruvbox-theme go-snippets go-projectile go-impl go-gopath go-errcheck go-direx go-complete gitignore-mode gitconfig-mode git-gutter flycheck-pos-tip flx-ido expand-region exec-path-from-shell evil-surround evil-search-highlight-persist evil-nerd-commenter evil-leader evil-goggles evil-easymotion eink-theme dashboard company-go clojure-mode bind-map basic-theme base16-theme auto-package-update airline-themes ace-window ace-jump-mode))))
(custom-set-faces
